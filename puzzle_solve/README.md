...
## piece extraction by opencv

```
python puzzle_solve/run_extraction.py
```

Then choose 2, by far edge detection is the best way. The result is at puzzle_solve/puzzle_pieces/edge_detection.

## piece mapping by opencv

```
python puzzle_solve/piece_position_mapper.py
```

## piece matching then reconstruct
...
```
python puzzle_solve/complete_puzzle_solver.py # default output puzzle_solve/mapped_pieces
python puzzle_solve/complete_puzzle_solver.py --output_dir puzzle_solve/mapped_pieces_camera
```
